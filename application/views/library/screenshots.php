...
<body>
        ...
        <div class="row">
          ...
          <div class="btn-toolbar" role="toolbar" style="margin: 0 auto; padding: 15px;">
            ...
            <div class="btn-group mr-2" role="group">
              ...
              <a href="<?php echo base_url(); ?>library/clips" class="btn btn-secondary">Game Clips</a>

            </div>

            <div class="btn-group mr-2" role="group">

              <a href="<?php echo base_url(); ?>library/screenshots" class="btn btn-primary">Screenshots</a>
    ...
    <script src="<?php echo asset_url("js/library.images.js"); ?>"></script>
